...
def setup(*args, **kwargs):
    ...
    0.1.0! Use instance of :class:`.Authomatic` class instead.

    """

    logging.warn(
        'The authomatic.setup function is deprecated and will be removed in '
        'version 0.1.0! Use an instance of the Authomatic class instead.')
...
def login(*args, **kwargs):
    ...
    This function is **deprecated** and will be removed in version
    0.1.0! Use the :meth:`.Authomatic.login` method instead.

    """

    logging.warn(
        'The authomatic.login function is deprecated and will be removed in '
        'version 0.1.0! Use the "login" method of the "Authomatic" class '
        'instead.')
...
def credentials(*args, **kwargs):
    ...
    This function is **deprecated** and will be removed in version
    0.1.0! Use the :meth:`.Authomatic.credentials` method instead.

    """

    logging.warn(
        'The authomatic.credentials function is deprecated and will be '
        'removed in version 0.1.0! Use the "credentials" method of the '
        '"Authomatic" class instead.')
...
def access(*args, **kwargs):
    ...
    This function is **deprecated** and will be removed in version
    0.1.0! Use the :meth:`.Authomatic.access` method instead.

    """

    logging.warn(
        'The authomatic.access function is deprecated and will be removed '
        'in version 0.1.0! Use the "access" method of the "Authomatic" '
        'class instead.')
...
def async_access(*args, **kwargs):
    ...
    This function is **deprecated** and will be removed in version
    0.1.0! Use the :meth:`.Authomatic.async_access` method instead.

    """

    logging.warn(
        'The authomatic.async_access function is deprecated and will be '
        'removed in version 0.1.0! Use the "async_access" method of the '
        '"Authomatic" class instead.')
...
def request_elements(*args, **kwargs):
    ...
    This function is **deprecated** and will be removed in version
    0.1.0! Use the :meth:`.Authomatic.request_elements` method instead.

    """

    logging.warn(
        'The authomatic.request_elements function is deprecated and will be '
        'removed in version 0.1.0! Use the "request_elements" method of the '
        '"Authomatic" class instead.')
...
def backend(*args, **kwargs):
    ...
    This function is **deprecated** and will be removed in version
    0.1.0! Use the :meth:`.Authomatic.backend` method instead.

    """

    logging.warn(
        'The authomatic.backend function is deprecated and will be removed ' +
        'in version 0.1.0! Use the "backend" method of the "Authomatic" '
        'class instead.')
